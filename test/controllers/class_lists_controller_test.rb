...
class ClassListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create class_list" do
    assert_difference('ClassList.count') do
      post class_lists_url, params: { class_list: { course_id: @class_list.course_id, description: @class_list.description, duration: @class_list.duration, lesson_name: @class_list.lesson_name, youtube_video_id: @class_list.youtube_video_id } }
    end
  ...
  test "should update class_list" do
    patch class_list_url(@class_list), params: { class_list: { course_id: @class_list.course_id, description: @class_list.description, duration: @class_list.duration, lesson_name: @class_list.lesson_name, youtube_video_id: @class_list.youtube_video_id } }
